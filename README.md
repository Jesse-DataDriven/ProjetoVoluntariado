...
Este repositório reúne projetos desenvolvidos de forma **100% voluntária**, com o objetivo de aplicar tecnologia, programação e inteligência artificial para **digitalizar negócios locais** e **fortalecer iniciativas comunitárias**.  
A proposta é simples: usar conhecimento técnico para gerar impacto real, acessível e sustentável.

---

# 💼 Projeto 1 — Solução Refrigeração  
### Prestador Autônomo de Ar-Condicionado

**Site publicado:** https://solucaorefrigeracao.netlify.app/

## 🎯 Objetivo
Criar presença digital profissional para um microempreendedor autônomo, ampliando alcance, credibilidade e canais de contato.

## 🧠 Solução Desenvolvida
- **Criação de site institucional** com foco em conversão e clareza.
- **Design minimalista**, pensado para o público-alvo e para navegação rápida.
- **Integração com WhatsApp e E-mail**, permitindo contato imediato.
